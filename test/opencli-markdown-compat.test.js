...
async function withMarkdownOpenCli(run, { detailExitCode = 0 } = {}) {
  ...
  const converted = expected
    .replace('**[C-001]**', '**\\[C-001\\]**')
    .replace('Inline [C1]', 'Inline \\[C1\\]');
