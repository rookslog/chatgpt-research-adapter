...
const ALLOWED_IMPORTS = Object.freeze({
  ...
  'src/setup.js': new Set(["node:crypto", "node:fs", "node:fs/promises", "node:path", "node:url", "./canonical-json.js"]),
...
const PROCESS_ALLOW = Object.freeze({
  ...
  'src/browser-host.js': ["pro" + "cess.platform", "pro" + "cess.kill(pid, 0)", "browser host did not report a pro" + "cess identity"],
